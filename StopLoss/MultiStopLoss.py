...
def multi_stop_loss(strategyName, symbolInfo, K_MIN, setname, stopLossTargetDictList, barxmdic, result_para_dic, tofolder, indexcols):
    ...
    barxm = DI.getDomainbarByDomainSymbol(symbolInfo.getSymbolList(), barxmdic, symbolDomainDic)
